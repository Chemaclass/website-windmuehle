export default {
  ...
  home: {
    ...
    gallery: [
      ...
      {
        text: 'Cultural events and workshops',
  ...
  donate: {
    ...
    supportText: 'The windmill restoration is budgeted at <strong>€166,600</strong>. Thanks to funding commitments from the <strong>EU (LEADER)</strong>, <strong>State</strong>, <strong>Hameln-Pyrmont District</strong>, <strong>Calenberg-Grubenhagensche Landschaft</strong> and the <strong>City of Hameln</strong>, this important project can be realized. The <strong>German Foundation for Monument Protection</strong> also supports us.',
